...
class ChessBoardController extends ValueNotifier<Chess> {
  ...
  late String piece_replacement;

  factory ChessBoardController(replacement){
    // String replacement = Proxy().getPiecesReplacement() as String;
    return ChessBoardController._(Chess(replacement), replacement);
  } 

  factory ChessBoardController.fromGame(Chess game, String replacement) =>
      ChessBoardController._(game, replacement);

  factory ChessBoardController.fromFEN(String fen, String replacement) =>
      ChessBoardController._(Chess.fromFEN(fen), replacement);

  ChessBoardController._(this.game, this.piece_replacement):
        super(game);
